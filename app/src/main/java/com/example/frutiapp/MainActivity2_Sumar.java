...
public class MainActivity2_Sumar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Nivel 1 - Sumas básica",Toast.LENGTH_SHORT).show();
    ...
    public void numAleatorio(){
        if(score <= 9){
            ...
            Intent intent = new Intent(this, MainActivity2_Sumar2.class);
